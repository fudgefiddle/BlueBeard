...
sealed class Operation(val address: String, internal val timeout: Long, internal val delay: Long) {
    ...
    class WriteDescriptor(address: String, val characteristicUuid: String, val descriptorUuid: String, val value: ByteArray, timeout: Long = 0L, delay: Long = 0L) :
            Operation(address, timeout, delay)
