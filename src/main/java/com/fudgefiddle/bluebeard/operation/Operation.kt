...
sealed class Operation() {
    ...
    internal abstract val attemptLimit: Int
    internal var attempts: Int = 0

    data class Connect(override val device: BluetoothDevice, override val timeout: Long = 0L, override val delay: Long = 0L, override val attemptLimit: Int = 0) : Operation() {
        constructor(address: String, timeout: Long = 0L, delay: Long = 0L) : this(getBlueoothDeviceFromAddress(address), timeout, delay)
    }

    data class Discover(override val device: BluetoothDevice, override val timeout: Long = 0L, override val delay: Long = 0L, override val attemptLimit: Int = 0) : Operation() {
        constructor(address: String, timeout: Long = 0L, delay: Long = 0L) : this(getBlueoothDeviceFromAddress(address), timeout, delay)
    }

    data class Disconnect(override val device: BluetoothDevice, override val timeout: Long = 0L, override val delay: Long = 0L, override val attemptLimit: Int = 0) : Operation() {
        constructor(address: String, timeout: Long = 0L, delay: Long = 0L) : this(getBlueoothDeviceFromAddress(address), timeout, delay)
    }

    data class Read(override val device: BluetoothDevice, val characteristic: Characteristic, override val timeout: Long = 0L, override val delay: Long = 0L, override val attemptLimit: Int = 0) : Operation() {
    ...
    data class Write(override val device: BluetoothDevice, val characteristic: Characteristic, val value: ByteArray, override val timeout: Long = 0L, override val delay: Long = 0L, override val attemptLimit: Int = 0) : Operation() {
    ...
    data class WriteDescriptor(override val device: BluetoothDevice, val descriptor: Descriptor, val value: ByteArray, override val timeout: Long = 0L, override val delay: Long = 0L, override val attemptLimit: Int = 0) : Operation() {
    ...
    data class Notification(override val device: BluetoothDevice, val characteristic: Characteristic, val enable: Boolean, override val timeout: Long = 0L, override val delay: Long = 0L, override val attemptLimit: Int = 0) : Operation() {
